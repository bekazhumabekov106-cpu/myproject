      ...
      <AnimatePresence mode="wait">
        ...
        {step === 3 && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            Спасибо, что приняла мое приглашение.<br /> Ты даже не представляешь, как я счастлив. <br />Я тебя люблю.💕
            <p className="text-sm mt-4">За подробностями напиши мне… я жду твоего сообщения. 💌</p>
            <Image
